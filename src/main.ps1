...
Clear-Host
Write-Host ""
Write-Host "### Connexion au disque réseau ###" -ForegroundColor Green
...
while (-not $connected) {
    ...
    Clear-Host
    Write-Host "Vous allez vous connecter à un disque réseau avec ce nom d'utilisateur :" -ForegroundColor Yellow
